...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "h4" because\n';
 ...
 * "/h4.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['h4'].superdevmode = true;

  var expectedSuffix = '/h4.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + h4 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:h4';
  var devModeSessionKey = '__gwtDevModeSession:h4';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/h4/h4.nocache.js';
  ...
  $wnd.__gwt_activeModules['h4'].canRedirect = true;
  $wnd.__gwt_activeModules['h4'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/h4?user.agent=' + ua + '&_callback=' + callback;
